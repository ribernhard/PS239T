...
This and all following files draw heavily on Rochelle Terman's 2016 guest lecture from last year, which is in turn based upon her full-length course on text analysis: https://github.com/rochelleterman/text-analysis-dhbsi/. Rochelle does cutting-edge work in this area, so we're following her lead! 
